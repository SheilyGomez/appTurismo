// frontend/src/screens/DestinoDetailScreen.js
    ...
    if (!images || images.length === 0) {
        return (
            <View style={styles.galleryPlaceholder}>
                <Ionicons name="image-outline" size={60} color={homeColors.textMuted} />
            </View>
        );
    }
    return (
    ...
    return (
        <View style={styles.starsRow}>
            {[...Array(fullStars)].map((_, i) => (
                <Ionicons key={`full_${i}`} name="star" size={size} color={homeColors.yellowStar} />
            ))}
            {hasHalfStar && (
                <Ionicons key="half" name="star-half" size={size} color={homeColors.yellowStar} />
            )}
            {[...Array(emptyStars)].map((_, i) => (
                <Ionicons key={`empty_${i}`} name="star-outline" size={size} color={homeColors.yellowStar} />
            ))}
        </View>
    );
};
            ...
            {[1, 2, 3, 4, 5].map((star) => (
                <TouchableOpacity key={star} onPress={() => setRating(star)}>
                    <Ionicons
                        ...
                        size={36}
                        color={star <= rating ? homeColors.primary : homeColors.textMuted}
            ...
            {esPropietario && (
                <View style={styles.resenaActions}>
                    <TouchableOpacity style={styles.resenaButton} onPress={() => onEdit(resena)}>
                        <Ionicons name="pencil-outline" size={16} color={homeColors.primary} />
...
const DestinoDetailScreen = ({ navigation }) => {
    ...
    const Header = () => (
        ...
        >
            <Ionicons name="arrow-back-outline" size={28} color={homeColors.white} />
        </TouchableOpacity>
    );
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.locationRow}>
                        <Ionicons name="location-outline" size={18} color={homeColors.textSecondary} />
                    ...
                    {destino.actividadPrincipalNombre && (
                        <View style={styles.actividadCard}>
                            <View style={styles.actividadCardHeader}>
                                <Ionicons name="ticket-outline" size={24} color={homeColors.primary} />
                                <Text style={styles.actividadCardTitle}>Actividad Principal</Text>
                            </View>
                            <Text style={styles.actividadCardNombre}>{destino.actividadPrincipalNombre}</Text>
                            <Text style={styles.actividadCardPrecio}>
                                ${(destino.precioPorPersona || 0).toFixed(2)} <Text style={{fontSize: 14, color: homeColors.textSecondary}}>/ persona</Text>
                            </Text>
                        </View>
                    )}
                    ...
                    {loadingResenas ? (
                        <ActivityIndicator color={homeColors.primary} style={{ marginTop: 20 }} />
                    ) : resenas.length === 0 ? (
                    ...
                    <View style={styles.modalContent}>
                        ...
                        >
                            {isUploadingImages ? (
                                ...
                                <Ionicons name="camera-outline" size={20} color={homeColors.primary} />
                            )}
                        ...
                        <View style={styles.modalButtonRow}>
                            ...
                            >
                                {isSubmitting ? (
                                    <ActivityIndicator size="small" color={homeColors.white} />
                                ) : (
